...
class Case:
    def __init__(self,type,nom,ncase,x,y,couleur=None,loyer=None):
        ...
        self.x=x
        self.y=y
        if self.couleur!=None and self.couleur!="gare":
            self.prix=loyers[ncase][0]
            self.nb_maison=0
    ...
    def mettre_une_maison(self):
        ...
        """
        if self.type=="Propriété" and self.couleur!="gare":
            if self.nb_maison<5:
...
class Joueur:
    def __init__(self,couleur):
        ...
        if self.couleur=="vert":
            ...
            self.affichage1=MonopolyFont.render("joueur 1:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.propriétés), True, blank)
        elif self.couleur=="bleu":
            self.pion=screen.pion_b
            self.affichage1=MonopolyFont.render("joueur 2:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.propriétés), True, blank)
            ...
            self.affichage1=MonopolyFont.render("joueur 3:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.propriétés), True, blank)
            ...
            self.affichage1=MonopolyFont.render("joueur 4:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.propriétés), True, blank)
    ...
    def tomber_chez_qqun(self,autre,propriété):
        ...
        if propriété.couleur=="gare":
            if self.argent>=autre.quan_propriété[propriété.couleur]*(2**(propriété.prix-1)):
                self.argent-=autre.quan_propriété[propriété.couleur]*(2**(propriété.prix-1))
                autre.argent+=autre.quan_propriété[propriété.couleur]*(2**(propriété.prix-1))
        else:
            if autre.quan_propriété[propriété.couleur]==max_couleur[propriété.couleur]:
                if self.argent>=propriété.prix*2:
                    self.argent-=propriété.prix*2
                    autre.argent+=propriété.prix*2
            elif self.argent>=propriété.prix:
                self.argent-=propriété.prix
                autre.argent+=propriété.prix
            else:
                while self.argent<propriété.prix:
                    if self.propriété==[]:
    ...
    def affichage(self):
        if self.couleur=="vert":
            ...
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.n_propriétés), True, blank)
            screen.init.blit(self.affichage1,(10,10))
            screen.init.blit(self.affichage2,(120,10))
            screen.init.blit(self.affichage3,(210,10))
            screen.init.blit(self.affichage4,(300,10))
            screen.init.blit(self.affichage5,(410,10))
        elif self.couleur=="bleu":
            self.affichage1=MonopolyFont.render("joueur 2:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.n_propriétés), True, blank)
            screen.init.blit(self.affichage1,(10,50))
            screen.init.blit(self.affichage2,(120,50))
            screen.init.blit(self.affichage3,(210,50))
            screen.init.blit(self.affichage4,(300,50))
            screen.init.blit(self.affichage5,(410,50))
        elif self.couleur=="rouge":
            self.pion=screen.pion_r
            self.affichage1=MonopolyFont.render("joueur 3:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            ...
            screen.init.blit(self.affichage4,(300,90))
            screen.init.blit(self.affichage5,(410,90))
        elif self.couleur=="jaune":
            self.affichage1=MonopolyFont.render("joueur 4:", True, blank)
            self.affichage2=MonopolyFont.render("argent:", True, blank)
            self.affichage3=MonopolyFont.render(str(self.argent), True, blank )
            self.affichage4=MonopolyFont.render("proriétés:", True, blank)
            self.affichage5=MonopolyFont.render(str(self.n_propriétés), True, blank)
            screen.init.blit(self.affichage1,(10,130))
            screen.init.blit(self.affichage2,(120,130))
            screen.init.blit(self.affichage3,(210,130))
            screen.init.blit(self.affichage4,(300,130))
            screen.init.blit(self.affichage5,(410,130))
...
def considérer_case(joueur,lancer1,lancer2):
    ...
    if prop.type=="propriété":
        ...
        if Compagnie_d_Eau in joueur.propriétés and Compagnie_d_Electricité in joueur.propriétés:
            joueur.argent-=(10*(lancer1+lancer2))
        else:
            joueur.argent-=(4*(lancer1+lancer2))
...
cartes_chances=[("Gagnez 10000",10000),("Allez à la rue de la Paix",Rue_de_la_Paix),("Payez des réparations : 4000 par maison / 11500 par hôtel",(4000,11500)),("Allez en prison",Allez_en_Prison),
...
cartes_communautés=[("Perdez 1000 ou tirez une carte chance",-1000),("Perdez 5000",-5000),("Gagnez 10000",10000),("Gagnez 2500",2500),("Gagnez 20000",20000),
